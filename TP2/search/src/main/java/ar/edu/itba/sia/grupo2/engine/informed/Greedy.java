...
public class Greedy<S> extends Search<S> {
    private final Queue<HeuristicNode<S>> queue;
    private final Heuristic<S> heuristic;

    public Greedy(final Heuristic<S> heuristic) {
        this.heuristic = Objects.requireNonNull(heuristic);
        this.queue = new PriorityQueue<>(Comparator.comparingDouble(n -> n.getHeuristicValue()));
    }

...
public class MeanDistanceAllPiecesTest {
    ...
    private MeanDistanceAllPieces heuristic = new MeanDistanceAllPieces();


    @Test
    public void correctDistance(){
        assertEquals(2.8, heuristic.getValue(senkuBoard), EPSILON);
    }
}

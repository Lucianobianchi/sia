...
switch algorithm
    case 'vanilla'
        [net, costs] = train(net, train_set, train_expected, epochs);
    case 'momentum'
        [net, costs] = train_momentum(net, train_set, train_expected, epochs, alfa);
    case 'adaptive'
        [net, costs] = train_adaptive(net, train_set, train_expected, epochs, lr_increase, lr_decrease_factor);
    otherwise

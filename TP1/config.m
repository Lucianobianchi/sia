...
n_inputs = 2;
n_outputs = 1;
hidden_layers = [50];    % array of the amount of neurons in each layer
...
batch_size = 5;
stop_early = false;
epochs = 25;                 % only used in train_script not in train_until_error
...
%% Plot terrain config
pts = rand(10000, 2) * 2 - 1;  % points to plot the terrain
